...
public class CustomerReservationAdapter extends RecyclerView.Adapter<CustomerReservationAdapter.ResViewHolder> {
    private List<ReservationEntity> reservationList;
    private AppDatabase db;

    public CustomerReservationAdapter(List<ReservationEntity> reservationList, AppDatabase db) {
    ...
    public ResViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_reservation_customer, parent, false);
